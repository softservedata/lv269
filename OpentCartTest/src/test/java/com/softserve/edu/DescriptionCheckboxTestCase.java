...
public class DescriptionCheckboxTestCase {
	...
	public void testCategorysearch(){
		...
		testData = Arrays.asList("Don't buy", "TEST PRODUCT", "DoYouSearchInDescription");
        ...
        /*
         * Submit description checkbox
         */
		driver.findElement(By.id("description")).click();
		/*
		 * Submit subcategory checkbox
		 */

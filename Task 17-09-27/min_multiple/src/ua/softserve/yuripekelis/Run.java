...
final class Run {
     ...
     * The constant with text for a part of the answer.
     */
    private static final String IS_TEXT = " is ";
    ...
    public static void main(final String[] args) {
        ...
        Integer firstNumber = CheckInput.enteredStringCheck(inputNumbers
                .getText(FIRST_NUMBER_TEXT));
        Integer secondNumber = CheckInput.enteredStringCheck(inputNumbers
                .getText(SECOND_NUMBER_TEXT));
